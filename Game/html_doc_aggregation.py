...
if __name__ == '__main__':
    ...
    # ************* Aggregation ***************
    # the concept here is that if the my_page object is deleted then my_body object should continue to exist and could
    ...
    new_body.add_tag('p', "The composed object doesnt actually own the objects that it is composed of"
                          " - in case it is destroyed, the composed objects continue to exist.")
